<script lang="ts">
	...
	// Base Classes
	const cBase = 'bg-surface-50 dark:bg-surface-900 text-xs md:text-base';
...
<div class="page-footer {cBase}">
	<div class="w-full max-w-7xl mx-auto p-2 py-8 md:py-16 space-y-5">
		...
		<section class={cRowTwo}>
				<i class="!text-sm opacity-80">© Copyright 2023 Medical History. All rights reserved.</i>
