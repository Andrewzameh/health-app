<script lang="ts">
	import Icon from '../lib/components/icons/logoMain.svelte'
	import Stepper from '../lib/components/landing/stepper.svelte'
...
<div>
	...
	<div class="variant-filled-secondary p-4 flex justify-between items-center gap-4">
		<div class="flex items-center gap-6">
			...
			<p><strong>Medical History</strong> now available! Join with 50% off</p>
		</div>
		<a class="btn variant-filled" href="/pricing" target="_blank">Pricing</a>
	</div>
